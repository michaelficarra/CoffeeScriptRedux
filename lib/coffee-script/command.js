...
var $0, $0, additionalArgs, CoffeeScript, concat, cscodegen, escodegen, esmangle, foldl, formatOptions, fs, humanReadable, input, input, inputName, inputSource, inspect, Jedediah, leftColumnWidth, maxWidth, numberLines, Optimiser, optionArguments, optionParser, optionRows, options, output, parameterArguments, parameterRows, path, pkg, positionalArgs, Preprocessor, processInput, Repl, row, rows, runMain, wrap;
fs = require('fs');
path = require('path');

...
if (null != escodegen) {
  ...
  [].push.apply(parameterArguments, [
    [
      ['source-map-file'],
      'FILE',
      'file used as output for source map when using --js'
    ],
    [
      [
        'require',
...
if (options.help) {
  ...
  processInput = function (err) {
    var cache$5, e, js, jsAST, result, sourceMap;
    if (null != err)
      throw err;
    result = null;
    ...
    try {
      cache$5 = CoffeeScript.jsWithSourceMap(jsAST, inputName, { compact: options.minify });
      js = cache$5.code;
      sourceMap = cache$5.map;
      cache$5;
    } catch (e$5) {
      e = e$5;
      console.error(e.stack || e.message);

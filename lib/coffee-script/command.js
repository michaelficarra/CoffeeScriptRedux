...
cache$4 = (null != options['normalize-urls'] ? options['normalize-urls'] : '').split(':');
sourceReferenceRoot = cache$4[0];
sourceReferenceRootReplacement = 2 <= cache$4.length ? [].slice.call(cache$4, 1) : [];

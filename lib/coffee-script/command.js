...
var $0, CoffeeScript, Optimiser, Preprocessor, additionalArgs, arg, args, concat, cscodegen, escodegen, foldl, formatOptions, fs, humanReadable, input, inspect, leftColumnWidth, longOptionArguments, longParameterArguments, match, maxWidth, numberLines, o, opt, optionArguments, optionMap, optionRows, options, opts, parameterArguments, parameterRows, path, pkg, positionalArgs, processInput, reLongOption, reLongParameter, reShortOptions, reShortOptionsShortParameter, reShortParameter, row, rows, shortOptionArguments, shortParameterArguments, uglifyjs, wrap, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
if (escodegen != null) {
  [].push.apply(optionArguments, [[['bare', 'b'], false, 'omit the top-level function wrapper'], [['js', 'j'], false, 'generate JavaScript output'], [['source-map'], false, 'generate source map'], [['eval', 'e'], false, 'evaluate compiled JavaScript'], [['repl'], false, 'run an interactive CoffeeScript REPL']]);
  if (uglifyjs != null) {
...
if (1 !== options.parse + options.compile + ((_ref6 = options.js) != null ? _ref6 : 0) + ((_ref7 = options['source-map']) != null ? _ref7 : 0) + ((_ref8 = options["eval"]) != null ? _ref8 : 0) + ((_ref9 = options.cscodegen) != null ? _ref9 : 0) + ((_ref10 = options.repl) != null ? _ref10 : 0)) {
...
if ((options.input != null) && (fs.statSync(options.input)).isDirectory() && (!(options.output != null) || ((_ref11 = fs.statSync(options.output)) != null ? _ref11.isFile() : void 0))) {
...
if (options.help) {
  ...
  processInput = function(err) {
    ...
    if (options['source-map']) {
      try {
        result = CoffeeScript.sourceMap(result, (_ref12 = options.input) != null ? _ref12 : options.cli && 'cli' || 'stdin');
      } catch (e) {
        console.error(e.stack || e.message);
        process.exit(1);
      }

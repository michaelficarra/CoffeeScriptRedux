...
if (options.help) {
  ...
  input = '';
  inputSource = null != options.input ? options.input : options.cli && '(cli)' || '(stdin)';
  processInput = function (err) {
    ...
    try {
      result = CoffeeScript.parse(input, {
        optimise: false,
        raw: options.raw || options['source-map'],

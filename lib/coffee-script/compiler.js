  ...
  defaultRules = [
    [
      ...
      CS.SoakedMemberAccessOp, function(_arg) {
        ...
        access = (_ref4 = this.memberName, __indexOf.call(jsReserved, _ref4) >= 0) ? new JS.MemberExpression(true, e, new JS.Literal(this.memberName)) : new JS.MemberExpression(false, e, new JS.Identifier(this.memberName));

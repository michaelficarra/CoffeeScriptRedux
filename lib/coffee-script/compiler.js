  ...
  defaultRules = [
    [
      ...
      CS.Class, function(_arg) {
        var args, block, ctor, fd, iife, instance, member, memberName, name, nameAssignee, params, parent, parentRef, protoMember, rewriteThis, _i, _j, _len, _len1, _ref3, _ref4;
        nameAssignee = _arg.nameAssignee, parent = _arg.parent, name = _arg.name, block = _arg.block;
        args = [];
        params = [];
        ...
        if (this.boundMembers.length) {
          instance = genSym('instance');
          _ref4 = this.boundMembers;
          for (_j = 0, _len1 = _ref4.length; _j < _len1; _j++) {
            memberName = _ref4[_j];
            member = memberAccess(new JS.ThisExpression, memberName);
            protoMember = memberAccess(memberAccess(name, 'prototype'), memberName);
            fn = new JS.FunctionExpression(null, [], new JS.BlockStatement([stmt(new JS.CallExpression(memberAccess(protoMember, 'apply'), [instance, new JS.Identifier('arguments')]))]));

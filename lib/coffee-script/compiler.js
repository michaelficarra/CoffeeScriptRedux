  ...
  defaultRules = [
    [
      ...
      CS.Switch, function(_arg) {
        var c, cases, elseBlock, expression, _i, _j, _len, _len1, _ref3;
      ...
      CS.Try, function(_arg) {
        var block, catchAssignee, catchBlock, e, finallyBlock, handlers;
        block = _arg.block, catchAssignee = _arg.catchAssignee, catchBlock = _arg.catchBlock, finallyBlock = _arg.finallyBlock;
        ...
        return new JS.TryStatement(forceBlock(block), handlers, finallyBlock);
      }
    ], [

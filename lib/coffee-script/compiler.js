...
var CS, JS, beingDeclared, concatMap, envEnrichments, exports, expr, makeReturn, map, statementNodes, stmt, union, usedAsExpression, _ref, _ref1, _ref2,
  __slice = [].slice,
...
expr = function(s) {
  ...
  if (!s["instanceof"].apply(s, statementNodes)) {
    ...
    return new JS.ConditionalExpression(s.test, expr(s.consequent), expr(s.alternate));
  } else {

...
helpers = {
  ...
  indexOf: function() {
    ...
    varDeclaration = new JS.VariableDeclaration([new JS.VariableDeclarator(i, new JS.Literal(0)), new JS.VariableDeclarator(length, new JS.MemberExpression(false, list, new JS.Identifier('length')))]);

  ...
  Compiler.prototype.compile = (function() {
    ...
    generateSymbols = (function() {
      ...
      handleNode = function(node, usedSymbols, nsCounters) {
        var declNames, decls, k, newNode, params, v, _nsCounters, _usedSymbols;
        if (node["instanceof"](JS.GenSym)) {
          ...
          _usedSymbols = nub(__slice.call(usedSymbols).concat(__slice.call(params)));
          _nsCounters = {};
          for (k in nsCounters) {
          ...
          declNames = map(concatMap(newNode.body.body, declarationsNeededFor), function(id) {
            return id.name;
          });
          decls = map(nub(difference(declNames, params)), function(name) {

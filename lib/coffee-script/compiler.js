...
var CS, JS, any, beingDeclared, concatMap, difference, enabledHelpers, envEnrichments, exports, expr, fn, foldl1, forceBlock, genSym, h, helpers, inlineHelpers, jsReserved, makeReturn, map, needsCaching, statementNodes, stmt, union, usedAsExpression, _ref, _ref1, _ref2,
...
helpers = {
  isOwn: function() {
    ...
    return new JS.FunctionDeclaration(new JS.Identifier('isOwn'), params, functionBody);
  }
};
  ...
  helpers[h] = (function(h, fn) {
    return function() {
      ...
      return (helpers[h] = function() {
        return new JS.CallExpression(new JS.Identifier("__" + h), arguments);
...
genSym = (function() {
  ...
  return function(pre) {
    ...
    return format(pre, genSymCounters[pre] = 0);
  };
})();
  ...
  defaultRules = [
    [
      CS.Program, function(_arg) {
        var block, declarations, declarator, inScope, program, v;

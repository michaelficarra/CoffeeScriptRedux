...
var CS, JS, any, beingDeclared, collectIdentifiers, concat, concatMap, declarationsNeededFor, difference, divMod, enabledHelpers, envEnrichments, exports, expr, fn, foldl1, forceBlock, genSym, generateMutatingWalker, h, helperNames, helpers, inlineHelpers, jsReserved, makeReturn, makeVarDeclaration, map, memberAccess, needsCaching, nub, owns, stmt, union, usedAsExpression, _ref, _ref1, _ref2,
  __slice = [].slice,
  ...
  defaultRules = [
    [
      ...
      CS.Class, function(_arg) {
        var args, block, compile, ctor, ctorRef, iife, instance, member, memberName, name, nameAssignee, params, parent, parentRef, protoAssignOp, protoMember, ps, rewriteThis, _, _i, _len, _ref3;
        ...
        if (this.boundMembers.length > 0) {
          ...
          for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
            ...
            fn = new JS.FunctionExpression(null, ps, new JS.BlockStatement([stmt(new JS.CallExpression(memberAccess(protoMember, 'apply'), [instance, new JS.Identifier('arguments')]))]));

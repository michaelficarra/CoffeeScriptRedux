  ...
  defaultRules = [
    [
      ...
      CS.ForIn, function(_arg) {
        var block, body, e, expression, filterExpr, i, keyAssignee, length, step, valAssignee, varDeclaration;
        valAssignee = _arg.valAssignee, keyAssignee = _arg.keyAssignee, expression = _arg.expression, step = _arg.step, filterExpr = _arg.filterExpr, body = _arg.body;
        i = genSym('i');
      ...
      CS.ForOf, function(_arg) {
        var block, body, e, expression, filterExpr, keyAssignee, right, valAssignee;
        keyAssignee = _arg.keyAssignee, valAssignee = _arg.valAssignee, expression = _arg.expression, filterExpr = _arg.filterExpr, body = _arg.body;
        block = forceBlock(body);

  ...
  defaultRules = [
    [
      ...
      CS.Class, function(_arg) {
        var args, block, compile, ctor, ctorRef, iife, instance, member, memberName, name, nameAssignee, params, parent, parentRef, protoMember, rewriteThis, _i, _len, _ref3;
        ...
        if ((this.boundMembers != null) && this.boundMembers.length > 0) {

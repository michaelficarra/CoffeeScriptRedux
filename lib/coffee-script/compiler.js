...
makeReturn = function(node) {
  ...
  } else if (node["instanceof"](JS.ThrowStatement, JS.ReturnStatement)) {
    return node;
  } else {
  ...
  defaultRules = [
    [
      ...
      CS.Class, function(_arg) {
        var args, block, compile, iife, name, nameAssignee, params, parent, parentRef;
      ...
      CS.ClassProtoAssignOp, function(_arg) {
        var a, ancestry, assignee, compile, expression, name, parentClass, protoMember, _i, _len;
        ...
        if (this.assignee.data === 'constructor') {
          name = compile(parentClass.name);
          if (this.expression["instanceof"](CS.Functions)) {
            return new JS.FunctionDeclaration(name, expression.params, forceBlock(compile(this.expression.block)));
          } else {
            return new JS.FunctionDeclaration(name, [], forceBlock(new JS.EmtpyStatement));
          }
        } else {

  ...
  defaultRules = [
    [
      ...
      CS.Class, function(_arg) {
        var args, block, compile, ctor, fd, iife, name, nameAssignee, params, parent, parentRef, pos, _i, _len, _ref3;
        ...
        _ref3 = block.body;
        for (pos = _i = 0, _len = _ref3.length; _i < _len; pos = ++_i) {
          fd = _ref3[pos];
        ...
        iife = new JS.CallExpression(new JS.MemberExpression(false, new JS.FunctionExpression(null, params, block), new JS.Identifier('call')), args);

...
var CS, JS, beingDeclared, concatMap, envEnrichments, exports, expr, foldl1, forceBlock, jsReserved, makeReturn, map, statementNodes, stmt, undef, union, usedAsExpression, _ref, _ref1, _ref2,
  __slice = [].slice,
  __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

_ref = require('./functional-helpers'), concatMap = _ref.concatMap, foldl1 = _ref.foldl1, map = _ref.map, union = _ref.union;
  ...
  defaultRules = [
    [
      ...
      CS.AssignOp, function(_arg) {
        var assignee, assignment, assignments, compile, expression, i, m;
        ...
        switch (false) {
          case !this.assignee["instanceof"](CS.ArrayInitialiser):
            assignments = (function() {
              ...
              for (i = _i = 0, _len = _ref3.length; _i < _len; i = ++_i) {
                m = _ref3[i];
                _results.push(new CS.AssignOp(m, new CS.DynamicMemberAccessOp(this.expression, new CS.Int(i))));
              }
              return _results;
            }).call(this);
            if (!assignments.length) {
              return compile(new CS.Undefined);
            }
          ...
          case !this.assignee["instanceof"](CS.ObjectInitialiser):
            assignments = (function() {
              ...
              for (i = _i = 0, _len = _ref3.length; _i < _len; i = ++_i) {
                m = _ref3[i];
                _results.push(new CS.AssignOp(m.expression, new CS.MemberAccessOp(this.expression, m.key.data)));
              }
              return _results;
            }).call(this);
            if (!assignments.length) {
          ...
          case !this.assignee["instanceof"](CS.Identifier, CS.MemberAccessOps):
      ...
      CS.DynamicMemberAccessOp, function(_arg) {
        var expression, indexingExpr, memberAccess;

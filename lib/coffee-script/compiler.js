...
_ref = require('./functional-helpers'), any = _ref.any, concatMap = _ref.concatMap, difference = _ref.difference, foldl1 = _ref.foldl1, map = _ref.map, nub = _ref.nub, owns = _ref.owns, union = _ref.union;
...
exports.Compiler = (function() {
  ...
  Compiler.prototype.compile = (function() {
    ...
    generateSymbols = (function() {
      ...
      generateName = function(node, usedSymbols, nsCounters) {
        var formatted, _ref3;
      ...
      handleNode = function(node, usedSymbols, nsCounters) {
        var decls, k, newNode, v, _nsCounters, _usedSymbols;
        if (node["instanceof"](JS.GenSym)) {
          ...
          _usedSymbols = usedSymbols.slice(0);
          _nsCounters = {};
          for (k in nsCounters) {
          ...
          return generateSymbols(node, usedSymbols, nsCounters);
        }
      };
          ...
          node[childName] = (function() {
            ...
            if (__indexOf.call(node.listMembers, childName) >= 0) {
              ...
              for (_j = 0, _len1 = _ref4.length; _j < _len1; _j++) {
                n = _ref4[_j];
                _results.push(handleNode(n, usedSymbols, nsCounters));
              }
              return _results;
            } else {
              return handleNode(node[childName], usedSymbols, nsCounters);
            }
          })();
        }
        return node;

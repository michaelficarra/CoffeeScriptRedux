...
var CS, beingDeclared, concatMap, difference, envEnrichments, envEnrichments_, foldl, nub, usedAsExpression, usedAsExpression_, _ref,
  __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
  __slice = [].slice;

_ref = require('./functional-helpers'), concatMap = _ref.concatMap, difference = _ref.difference, foldl = _ref.foldl, nub = _ref.nub;
...
this.beingDeclared = beingDeclared = function(assignment) {
  switch (false) {
    case !!(assignment != null):
      return [];
    case !assignment["instanceof"](CS.Identifier, CS.GenSym):

...
envEnrichments_ = function() {
  ...
  switch (false) {
    ...
    case !this["instanceof"](CS.Switch):
      return nub(concatMap([this.expr, this.elseBlock].concat(__slice.call(this.cases)), function(e) {
        return envEnrichments(e);
      }));
    case !this["instanceof"](CS.SwitchCase):
      return nub(concatMap([this.block].concat(__slice.call(this.conditions)), function(e) {
        return envEnrichments(e);
      }));
    default:

...
var CoffeeScript, Compiler, cscodegen, escodegen, escodegenCompactDefaults, escodegenFormatDefaults, formatParserError, fs, Nodes, Optimiser, Parser, path, pkg, Preprocessor, run, uglifyjs;
fs = require('fs');
path = require('path');

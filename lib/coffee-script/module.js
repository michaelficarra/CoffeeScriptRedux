...
var CoffeeScript, Compiler, Optimiser, Parser, Preprocessor, cleanMarkers, cscodegen, escodegen, formatParserError, fs, humanReadable, packageJSON, path, uglifyjs;
...
module.exports = {
  ...
  parse: function(coffee) {
    try {
      return Parser.parse(Preprocessor.processSync(coffee));
    } catch (e) {
  ...
  compile: function(csAst, options) {
    return Compiler.compile(Optimiser.optimise(csAst));
  },

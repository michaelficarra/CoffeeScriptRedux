...
(function() {
  ...
  this.ArrayInitialiser = (function(_super) {
    ...
    ArrayInitialiser.prototype.envEnrichments = function() {
      return concatMap(this.members, function(member) {
        return member.envEnrichments();
      });
    };

...
(function() {
  ...
  this.ShallowCopyArray = (function(_super) {

    __extends(ShallowCopyArray, _super);
  ...
  this.UnboundedLeftSlice = (function(_super) {

    __extends(UnboundedLeftSlice, _super);
  ...
  this.UnboundedRightSlice = (function(_super) {

    __extends(UnboundedRightSlice, _super);

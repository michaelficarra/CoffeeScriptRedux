...
createNodes({
  Nodes: [
    [], {
      ...
      ForIn: [['valAssignee', 'keyAssignee', 'expression', 'step', 'filterExpr', 'body']],
      ForOf: [['isOwn', 'keyAssignee', 'valAssignee', 'expression', 'filterExpr', 'body']],
...
exports.Loop = (function(_super) {
  ...
  function Loop(body) {
    Loop.__super__.constructor.call(this, (new Bool(true)).g(), body);
  }

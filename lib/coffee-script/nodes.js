...
(function() {
  var AssignOp, BinOp, Block, Bool, NO, Primitive, Statement, UnaryOp, YES, any, beingDeclared, concat, concatMap, difference, foldl, intersect, map, nub, union,
  ...
  beingDeclared = function(param, list) {
    if (list == null) {
      list = [];
    }
    switch (param.className) {
      case 'Identifier':
        return [param];
      case 'AssignOp':
        return beingDeclared(param.assignee);
      case 'ArrayInitialiser':
        return concatMap(param.members, beingDeclared);
      case 'ObjectInitialiser':
        return concatMap(param.vals(), beingDeclared);
      default:
        return [];
    }
  };
  ...
  this.Node = (function() {
    ...
    Node.prototype.walk = function(fn, inScope, ancestry) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        childName = _ref[_i];
        while (this[childName] !== (this[childName] = fn.call(child, inScope, ancestry))) {
          continue;
        }
        inScope = union(inScope, this[childName].envEnrichments());
      }
      return this;
    };
  ...
  BinOp = (function(_super) {
    ...
    BinOp.prototype.mayHaveSideEffects = function(inScope) {
      return (this.left.mayHaveSideEffects(inScope)) || this.right.mayHaveSideEffects(inScope);
    };
  ...
  UnaryOp = (function(_super) {
    ...
    UnaryOp.prototype.mayHaveSideEffects = function(inScope) {
      return this.expr.mayHaveSideEffects(inScope);
    };
  ...
  this.ArrayInitialiser = (function(_super) {
    ...
    ArrayInitialiser.prototype.walk = function(fn, inScope, ancestry) {
      ...
      this.members = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          member = _ref[_i];
          while (member !== (member = fn.call(member, inScope, ancestry))) {
            continue;
          }
  ...
  Block = this.Block = (function(_super) {
    ...
    Block.prototype.walk = function(fn, inScope, ancestry) {
      ...
      this.statements = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          statement = _ref[_i];
          while (statement !== (statement = fn.call(statement, inScope, ancestry))) {
            continue;
          }
  ...
  this.Class = (function(_super) {
    ...
    Class.prototype.mayHaveSideEffects = function(inScope) {
      var _this = this;
      return any([this.nameAssignment, this.parent, this.block], function(v) {
        return v.mayHaveSideEffects(inScope);
      });
    };
  ...
  this.Conditional = (function(_super) {
    ...
    Conditional.prototype.isTruthy = function() {
      var _ref, _ref1;
      return !!(this.condition.isTruthy() && ((_ref = this.block) != null ? _ref.isTruthy() : void 0) || this.condition.isFalsey() && ((_ref1 = this.elseBlock) != null ? _ref1.isTruthy() : void 0));
    };

    Conditional.prototype.isFalsey = function() {
      var _ref, _ref1;
      return !!(this.condition.isTruthy() && ((_ref = this.block) != null ? _ref.isFalsey() : void 0) || this.condition.isFalsey() && ((_ref1 = this.elseBlock) != null ? _ref1.isFalsey() : void 0));
    };

    Conditional.prototype.mayHaveSideEffects = function(inScope) {
      var _ref, _ref1;
      return !!((this.condition.mayHaveSideEffects(inScope)) || ((_ref = this.block) != null ? _ref.mayHaveSideEffects(inScope) : void 0) || ((_ref1 = this.elseBlock) != null ? _ref1.mayHaveSideEffects(inScope) : void 0));
    };
  ...
  this.DoOp = (function(_super) {
    ...
    DoOp.prototype.mayHaveSideEffects = function(inScope) {
      var args, newScope, p, _ref,
        _this = this;
      if ((_ref = this.expr.className) !== 'Function' && _ref !== 'BoundFunction') {
        return true;
      }
  ...
  this.DynamicMemberAccessOp = (function(_super) {
    ...
    DynamicMemberAccessOp.prototype.mayHaveSideEffects = function(inScope) {
      return (this.expr.mayHaveSideEffects(inScope)) || (this.indexingExpr.mayHaveSideEffects(inScope));
    };
  ...
  this.Function = (function(_super) {
    ...
    Function.prototype.childNodes = ['block'];
  ...
  this.FunctionApplication = (function(_super) {
    ...
    FunctionApplication.prototype.walk = function(fn, inScope, ancestry) {
      ...
      ancestry.push(this);
      while (this["function"] !== (this["function"] = fn.call(this["function"], inScope, ancestry))) {
        continue;
      }
      ...
      this["arguments"] = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          arg = _ref[_i];
          while (arg !== (arg = fn.call(arg, inScope, ancestry))) {
            continue;
          }
    ...
    FunctionApplication.prototype.mayHaveSideEffects = function(inScope) {
      var newScope, _ref,
        _this = this;
      if ((_ref = this["function"].className) !== 'Function' && _ref !== 'BoundFunction') {
        return true;
      }
  ...
  this.HeregExp = (function(_super) {
    ...
    HeregExp.prototype.mayHaveSideEffects = function(inScope) {
      return this.expr.mayHaveSideEffects(inScope);
    };
  ...
  this.MemberAccessOp = (function(_super) {
    ...
    MemberAccessOp.prototype.mayHaveSideEffects = function(inScope) {
      return this.expr.mayHaveSideEffects(inScope);
    };
  ...
  this.NewOp = (function(_super) {
    ...
    NewOp.prototype.walk = function(fn, inScope) {};
  ...
  this.ObjectInitialiser = (function(_super) {
    ...
    ObjectInitialiser.prototype.walk = function(fn, inScope) {};
  ...
  this.Program = (function(_super) {
    ...
    Program.prototype.isTruthy = function() {
      var _ref;
      return !!((_ref = this.block) != null ? _ref.isTruthy() : void 0);
    };

    Program.prototype.isFalsey = function() {
      var _ref;
      return !!((_ref = this.block) != null ? _ref.isFalsey() : void 0);
    };

    Program.prototype.mayHaveSideEffects = function(inScope) {
      var _ref;
      return !!((_ref = this.block) != null ? _ref.mayHaveSideEffects(inScope) : void 0);
    };
  ...
  this.Slice = (function(_super) {
    ...
    Slice.prototype.mayHaveSideEffects = function(inScope) {
      var _ref, _ref1;
      return !!((this.expr.mayHaveSideEffects(inScope)) || ((_ref = this.left) != null ? _ref.mayHaveSideEffects(inScope) : void 0) || ((_ref1 = this.right) != null ? _ref1.mayHaveSideEffects(inScope) : void 0));
    };
  ...
  this.Super = (function(_super) {
    ...
    Super.prototype.walk = function(fn, inScope) {};
  ...
  this.Switch = (function(_super) {
    ...
    Switch.prototype.walk = function(fn, inScope) {};
  ...
  this.While = (function(_super) {
    ...
    While.prototype.mayHaveSideEffects = function(inScope) {
      return (this.condition.mayHaveSideEffects(inScope)) || this.block.mayHaveSideEffects(inScope);
    };

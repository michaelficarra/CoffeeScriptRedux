...
exports.Optimiser = (function() {
    ...
    [
      ...
      CS.SeqOp, function(inScope, ancestors) {
        ...
        if (mayHaveSideEffects(this.left, inScope)) {
          ...
          if (canDropLast && !mayHaveSideEffects(this.right, inScope)) {
      ...
      CS.ArrayInitialiser, function(inScope, ancestors) {
        var m, members, originalLength;
        if (usedAsExpression(this, ancestors)) {
          return this;
        }
        originalLength = this.members.length;
        members = (function() {
          var _i, _len, _ref3, _results;
          _ref3 = this.members;
          _results = [];
          for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
            m = _ref3[_i];
            if (mayHaveSideEffects(m, inScope)) {
              _results.push(m);
            }
          }
          return _results;
        ...
        if (members.length === originalLength) {
          ...
          return (new CS.ArrayInitialiser(members)).g();
        }
      }
    ], [
  ...
  Optimiser.prototype.optimise = (function() {
    ...
    return function(ast) {
      var rules;
      rules = this.rules;
      return walk.call(ast, function(inScope, ancestry) {

  ...
  defaultRules = [
    [
      ...
      CS.ForIn, function() {
        ...
        return new CS.ForIn(this.valAssignee, this.keyAssignee, this.expression, this.step, null, this.body);
      }
    ], [
      CS.ForOf, function() {
        if (!isTruthy(this.filterExpr)) {
        ...
        return new CS.ForOf(this.isOwn, this.keyAssignee, this.valAssignee, this.expression, null, this.body);
      }
    ], [

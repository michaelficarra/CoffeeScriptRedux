...
var CS, all, any, beingDeclared, concat, concatMap, declarationsFor, difference, envEnrichments, exports, foldl, foldl1, isFalsey, isTruthy, makeDispatcher, mayHaveSideEffects, union, usedAsExpression, walk, _ref, _ref1, _ref2,
  __slice = [].slice,
    ...
    [
      ...
      CS.Block, function(inScope, ancestors) {
        switch (this.statements.length) {
          ...
          default:
            return foldl1(this.statements, function(expr, s) {

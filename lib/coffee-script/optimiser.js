...
(function() {
  ...
  this.Optimiser = (function() {
    ...
    function Optimiser() {
      var applicableCtors, ctor, handler, _i, _j, _len, _len1, _ref;
      this.rules = {};
      for (_i = 0, _len = defaultRules.length; _i < _len; _i++) {
        _ref = defaultRules[_i], applicableCtors = _ref[0], handler = _ref[1];
        for (_j = 0, _len1 = applicableCtors.length; _j < _len1; _j++) {
          ctor = applicableCtors[_j];
          this.addRule(ctor.className, handler);
        }
      }
    }
    ...
    Optimiser.prototype.addRule = function(ctor, handler) {
      var _base, _ref;
      ((_ref = (_base = this.rules)[ctor]) != null ? _ref : _base[ctor] = []).push(handler);
    };
    ...
    Optimiser.prototype.optimise = function(ast) {
      ...
      return ast.walk(function(inScope, ancestry) {
        var memo, rule, _i, _len, _ref, _ref1;
        memo = this;
        _ref1 = (_ref = rules[this.className]) != null ? _ref : [];

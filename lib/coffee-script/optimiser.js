...
exports.Optimiser = function () {
  ...
  defaultRules = [
    ...
    [
      CS.SeqOp,
      function (param$) {
        var ancestry, cache$2, canDropLast, inScope, ref;
        {
          cache$2 = param$;
      ...
      for (var i$ = 0, length$ = this.childNodes.length; i$ < length$; ++i$) {
        ...
        this[childName] = in$(childName, this.listMembers) ? function (accum$) {
          ...
          for (var i$1 = 0, length$1 = this[childName].length; i$1 < length$1; ++i$1) {
            ...
            while (member !== walk.call(member = fn.call(member, {
                inScope: inScope,
                ancestry: ancestry
              }), fn, inScope, ancestry)) {
            }
          ...
          while (child !== walk.call(child = fn.call(child, {
              inScope: inScope,
              ancestry: ancestry
            }), fn, inScope, ancestry)) {
          }

...
mayHaveSideEffects = makeDispatcher(false, [
  [
    ...
    [CS.Break, CS.Continue, CS.DeleteOp, CS.NewOp, CS.Return, CS.Super, CS.PreDecrementOp, CS.PreIncrementOp, CS.PostDecrementOp, CS.PostIncrementOp, CS.ClassProtoAssignOp, CS.Constructor, CS.Throw], function() {
      return true;
    }
  ], [

  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_INDENT() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, ws) { return ws + '(INDENT)'; })(r1.offset, r1.line, r1.column, r3);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_DEDENT() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, t, ws) { return t + ws + '(DEDENT)'; })(r1.offset, r1.line, r1.column, r3, r4);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_TERM() {
        ...
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column) { return '(TERM)'; })(r1.offset, r1.line, r1.column);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
      ...
      function parse_MemberAccessOps() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, ws0, ws1, ws2, ws3, e) { return {op: CS.MemberAccessOp, operands: [e], raw: ws0 + ws1 + '.' + ws2 + ws3 + e, line: line, column: column}; })(r1.offset, r1.line, r1.column, r3, r4, r6, r7, r8);
        }
        if (r0 === null) {
          pos = clone(r1);
        }

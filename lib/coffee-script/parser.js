module.exports = (function(){
  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_assignmentExpressionNoImplicitObjectCall() {
        ...
        if (r0 === null) {
          ...
          if (r0 === null) {
            ...
            if (r0 === null) {
              r0 = parse_lowBinaryExpressionNoImplicitObjectCall();
            }
          }
        }
      ...
      function parse_lowBinaryExpression() {
        var cacheKey = "lowBinaryExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
            ...
            if (r9 !== null) {
              ...
              if (r10 !== null) {
                ...
                if (r11 !== null) {
                  ...
                  if (r12 === null) {
                    r12 = parse_comparisonExpression();
                  }
                  if (r12 !== null) {
      ...
      function parse_lowBinaryOperator() {
        var cacheKey = "lowBinaryOperator@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_lowBinaryExpressionNoImplicitObjectCall() {
        var cacheKey = "lowBinaryExpressionNoImplicitObjectCall@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
            ...
            if (r9 !== null) {
              ...
              if (r10 !== null) {
                ...
                if (r11 !== null) {
                  r12 = parse_expressionworthy();
                  if (r12 === null) {
                    r12 = parse_comparisonExpressionNoImplicitObjectCall();
                  }
                  if (r12 !== null) {
                    r5 = [r8, r9, r10, r11, r12];
                  } else {
          ...
          if (r7 !== null) {
            ...
            if (r8 !== null) {
              ...
              if (r9 !== null) {
                ...
                if (r10 === null) {
                  r10 = parse_highBinaryExpression();
                }
                if (r10 !== null) {
                  r5 = [r7, r8, r9, r10];
                } else {
      ...
      function parse_comparisonExpressionNoImplicitObjectCall() {
        ...
        r1 = pos;
        r2 = pos;
        r3 = parse_highBinaryExpressionNoImplicitObjectCall();
        if (r3 !== null) {
          r4 = [];
          r6 = pos;
          r7 = parse__();
          if (r7 !== null) {
            ...
            if (r8 !== null) {
              ...
              if (r9 !== null) {
                r10 = parse_expressionworthy();
                if (r10 === null) {
                  r10 = parse_highBinaryExpressionNoImplicitObjectCall();
                }
                if (r10 !== null) {
                  r5 = [r7, r8, r9, r10];
                } else {
      ...
      function parse_highBinaryExpression() {
        var cacheKey = "highBinaryExpression@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_highBinaryOperator() {
        var cacheKey = "highBinaryOperator@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_highBinaryExpressionNoImplicitObjectCall() {
        var cacheKey = "highBinaryExpressionNoImplicitObjectCall@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;

  ...
  var result = {
    ...
    parse: function(input, startRule) {
        ...
        if (r0 === null) {
          ...
          if (r0 === null) {
            ...
            if (r0 === null) {
              ...
              if (r0 !== null) {
                r0 = (function(offset, line, column, e) { return new CS.UnaryPlusOp(e).r('+' + e.raw).p(line, column); })(r1.offset, r1.line, r1.column, r4);
              }
              if (r0 === null) {
                pos = clone(r1);
              }
              if (r0 === null) {
                ...
                if (r0 !== null) {
                  r0 = (function(offset, line, column, e) { return new CS.UnaryNegateOp(e).r('-' + e.raw).p(line, column); })(r1.offset, r1.line, r1.column, r4);
                }
                if (r0 === null) {
                  pos = clone(r1);
                }
                if (r0 === null) {
                  ...
                  if (r0 === null) {
                    ...
                    if (r0 !== null) {
                      r0 = (function(offset, line, column) { return new CS.BitNotOp(e).r('~' + ws + e.raw).p(line, column); })(r1.offset, r1.line, r1.column);
                    }
                    if (r0 === null) {
                      pos = clone(r1);
                    }
      ...
      function parse_MemberAccessOps() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, ws, e) { return {op: CS.MemberAccessOp, operands: [e], raw: '.' + ws + e, line: line, column: column}; })(r1.offset, r1.line, r1.column, r4, r5);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_ObjectInitialiserKeys() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, i) { return new CS.String(i).r(i).p(line, column); })(r1.offset, r1.line, r1.column, r0);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_hereregexpData() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, d) { return [new CS.String("[").g().p(line, column)].concat(d || []).concat([new CS.String("]").g().p(line, column)]); })(r1.offset, r1.line, r1.column, r4);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, c) { return [new CS.String(c).g().p(line, column)]; })(r1.offset, r1.line, r1.column, r4);
          }
          if (r0 === null) {
            pos = clone(r1);
          }
          if (r0 === null) {
            ...
            if (r0 !== null) {
              r0 = (function(offset, line, column, s) { return [new CS.String(s.join('')).g().p(line, column)]; })(r1.offset, r1.line, r1.column, r0);
            }
            if (r0 === null) {
              pos = clone(r1);
            }
            if (r0 === null) {
              ...
              if (r0 !== null) {
                r0 = (function(offset, line, column, c) { return [new CS.String(c).g().p(line, column)]; })(r1.offset, r1.line, r1.column, r3);
              }
              if (r0 === null) {
                pos = clone(r1);
              }

    ...
    parse: function(input, startRule) {
      ...
      function parse_hereregexpData() {
        ...
        if (r3 !== null) {
          ...
          if (r5 === null) {
            if (/^[^\\\/\] { return new CS.String(s).p(line, column); }]/.test(input.charAt(pos.offset))) {
              r5 = input.charAt(pos.offset);
              advance(pos, 1);
            } else {
              r5 = null;
              if (reportFailures === 0) {
                matchFailed("[^\\\\\\/\\] { return new CS.String(s).p(line, column); }]");
              }
            }
          }
          while (r5 !== null) {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, d) {
                return [new CS.String("[").p(line, column)].concat(d || []).concat([new CS.String("]").p(line, column)]); })(r1.offset, r1.line, r1.column, r4);
        }
        if (r0 === null) {
          pos = clone(r1);
        }

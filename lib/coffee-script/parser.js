  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_conditionalBody() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ws, t, b) { return {block: b, raw: t + b.raw}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[3]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_classBody() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ws, t, b) { return {block: b, raw: ws + t + b.raw}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[3]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, ws, t) {
      ...
      function parse_functionLiteral() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, argList, arrow, body) {
            var raw = '', args = [];
            if(argList) {
              args = argList[2];

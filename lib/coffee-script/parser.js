  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_MemberNames() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, i) { return new Nodes.Identifier(i).r(i).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }

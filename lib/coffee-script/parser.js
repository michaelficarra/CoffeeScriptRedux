  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_functionBody() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ws, t0, b, t1) { return {block: b, raw: ws + t0 + b.raw + t1}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[3], result0[5]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }

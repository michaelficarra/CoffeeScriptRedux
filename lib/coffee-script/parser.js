  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_argumentList() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, a) {
                return 0,
          ...
          if (r4 !== null) {
            ...
            if (r5 !== null) {
              ...
              if (r6 !== null) {
                ...
                r9 = parse_TERMINDENT();
                if (r9 !== null) {
                  r10 = parse_implicitObjectLiteral();
                  if (r10 !== null) {
                    r11 = parse_DEDENT();
                    if (r11 !== null) {
                      r7 = [r9, r10, r11];
      ...
      function parse_memberExpression() {
        ...
        if (r3 === null) {
          ...
          if (r3 !== null) {
            r3 = (function(offset, line, column, ws0, e, args) { return new CS.NewOp(e, args.operands[0]).r('new' + ws0 + e + args.raw).p(line, column); })(r4.offset, r4.line, r4.column, r7, r8, r9);
          }
          if (r3 === null) {
            pos = clone(r4);
          }
      ...
      function parse_MemberAccessOps() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, ws0, ws1, ws2, ws3, e) { return {op: CS.MemberAccessOp, operands: [e], raw: ws0 + (ws1 ? ws1[0] + ws1[1] : '') + '.' + ws2 + (ws3 ? ws3[0] + ws3[1] : '') + e, line: line, column: column}; })(r1.offset, r1.line, r1.column, r3, r4, r6, r7, r8);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
                            ...
                            if (r0 === null) {
                              ...
                              if (r0 === null) {
                                ...
                                if (r0 === null) {
                                  ...
                                  if (r0 !== null) {
                                    r0 = (function(offset, line, column, t, e, d) {
                                        e.raw = '(' + t + e.raw + d + ')';
                                        return e;
                                      })(r1.offset, r1.line, r1.column, r4, r5, r6);
                                  }
      ...
      function parse_parameter() {
        ...
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, i) { return new CS.Rest(i).r(i.raw + '...').p(line, column); })(r1.offset, r1.line, r1.column, r3);
          }
          if (r0 === null) {
            pos = clone(r1);
          }

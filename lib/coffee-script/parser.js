  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_primaryExpression() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            result0 = parse_THIS();
            if (result0 !== null) {
              result0 = (function(offset, line, column) { return new Nodes.Identifier("this").r("this").p(line, column); })(pos0.offset, pos0.line, pos0.column);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
      ...
      function parse_argumentList() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, e, s, es) {

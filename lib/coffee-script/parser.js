(function(){
    ...
    parse: function(input, startRule) {
                  ...
                  if (result4 !== null) {
                    ...
                    if (result5 !== null) {
                      ...
                      if (result6 !== null) {
                        ...
                        if (result8 !== null) {
                          result8 = (function(offset, line, column, ws, a) { return {raw: ws + a.raw, type: a.op, operand: a.operand}; })(pos2.offset, pos2.line, pos2.column, result8[0], result8[1]);
                        }
                        if (result8 === null) {
                          pos = clone(pos2);
                        }
                        if (result8 === null) {
                          ...
                          if (result8 !== null) {
                            result8 = (function(offset, line, column, a) { return {raw: '', type: '(', operand: a ? a[0].list : []}; })(pos2.offset, pos2.line, pos2.column, result8[2]);
                          }
                          if (result8 === null) {
                            pos = clone(pos2);
                          }
      ...
      function parse_memberExpression() {
        ...
        if (result0 !== null) {
          ...
          if (result2 !== null) {
            result2 = (function(offset, line, column, ws, a) { return {raw: ws + a.raw, type: a.op, operand: a.operand}; })(pos2.offset, pos2.line, pos2.column, result2[0], result2[1]);
          }
          if (result2 === null) {
            pos = clone(pos2);
          }
          if (result2 === null) {
            ...
            if (result2 !== null) {
              result2 = (function(offset, line, column, a) { return {raw: '', type: '(', operand: a ? a[0].list : []}; })(pos2.offset, pos2.line, pos2.column, result2[2]);
            }
            if (result2 === null) {
              pos = clone(pos2);
            }
      ...
      function parse_MemberAccessOps() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, op, ws, e) { return {op: op, operand: e, raw: op + ws + e}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, op, ws0, e, ws1) { return {op: op, operand: e, raw: op + ws0 + e + ws1 + ']'}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2], result0[3]);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
      ...
      function parse_conditional() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, kw, ws0, cond, ws1, body, term, elseClause) {
      ...
      function parse_elseClause() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ws, b) { return {block: b.block, raw: ws + 'else' + b.raw}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_hereregexpData() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column) { return [new Nodes.String(' ').g().p(line, column)]; })(pos0.offset, pos0.line, pos0.column);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
  ...
  var SyntaxError = result.SyntaxError = function(expected, found, offset, line, column) {
  ...
  SyntaxError.prototype = (function(){
    var F = function(){

  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_contextVar() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, m) { return new Nodes.MemberAccessOp((new Nodes.This).r("@").p(line, column), m).r("@" + m).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }

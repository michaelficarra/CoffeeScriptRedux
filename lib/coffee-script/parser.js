  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_TERMINATOR() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, necessary, superfluous) {
      ...
      function parse_postfixControlFlowOp() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, all) { return [all[0], all]; })(pos0.offset, pos0.line, pos0.column, result0);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, all) { return ['for-in', all]; })(pos0.offset, pos0.line, pos0.column, result0);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column, all) { return ['for-of', all]; })(pos0.offset, pos0.line, pos0.column, result0);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
      ...
      function parse_memberExpression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, expr, accesses) {
      ...
      function parse_contextVar() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, m) { return new Nodes.MemberAccessOp(new Nodes.Identifier("this").r("@").p(line, column), m).r("@" + m).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column, r) { return new Nodes.Identifier("this").r(r).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
      ...
      function parse_conditional() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = parse__();
              if (result3 !== null) {
                result4 = parse_conditionalBody();
                if (result4 !== null) {
                  pos2 = clone(pos);
                  result5 = parse__();
                  if (result5 !== null) {
                    result6 = parse_elseClause();
                    if (result6 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, kw, ws0, cond, ws1, body, elseClause) {
      ...
      function parse_elseClause() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, ws, b) { return {block: b.block, raw: 'else' + ws + b.raw}; })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_conditionalBody() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, t, b) { return {block: b, raw: t + b.raw}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_while() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, kw, ws0, cond, ws1, body) {
      ...
      function parse_class() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, name, parent, ws, term, block) {
          ...
          })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2], result0[3], result0[4], result0[6]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, name, parent, block) {
              var raw = 'class' + (name ? name[0] + name[1].raw : '') +
                (parent ? parent[0] + 'parent' + parent[2] + parent[3].raw : '') +
      ...
      function parse_functionLiteral() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result2 = (function(offset, line, column, all) { return ['expr'].concat(all); })(pos2.offset, pos2.line, pos2.column, result2);
            }
            if (result2 === null) {
              pos = clone(pos2);
            }
            if (result2 === null) {
              ...
              if (result2 !== null) {
                result3 = parse_TERMINATOR();
                if (result3 !== null) {
                  result4 = parse_INDENT();
                  if (result4 !== null) {
                    result5 = parse_block();
                    if (result5 !== null) {
                      result6 = parse_DEDENT();
                      if (result6 !== null) {
                        result2 = [result2, result3, result4, result5, result6];
                      } else {
                        result2 = null;
              ...
              if (result2 !== null) {
                result2 = (function(offset, line, column, all) { return ['block'].concat(all); })(pos2.offset, pos2.line, pos2.column, result2);
              }
              if (result2 === null) {
                pos = clone(pos2);
              }
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, argList, arrow, block) {
          var raw = '', args = [];
          if(argList) {
            args = argList[2];
      ...
      function parse_integer() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, a, bs) { return a + bs.join(''); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }

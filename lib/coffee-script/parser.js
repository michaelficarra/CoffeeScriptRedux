  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "namesDestructuringMember": parse_namesDestructuringMember,
                ...
                if (result0 === null) {
                  ...
                  if (result0 === null) {
                    ...
                    if (result0 === null) {
                      ...
                      if (result0 !== null) {
                        result0 = (function(offset, line, column, ws, e) { return new Nodes.DoOp(e).r('-' + ws + e.raw).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
                      }
                      if (result0 === null) {
                        pos = clone(pos0);
                      }
      ...
      function parse_namesDestructuringMember() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1, pos2;

    ...
    parse: function(input, startRule) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    ...
                    if (result6 === null) {
                      result6 = parse_logicalOrExpression();
                    }
                    if (result6 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  if (result5 !== null) {
                    result6 = parse_functionLiteral();
                    if (result6 === null) {
                      result6 = parse_logicalAndExpression();
                    }
                    if (result6 !== null) {
                      result1 = [result1, result2, result3, result4, result5, result6];
                    } else {
      ...
      function parse_switchBody() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, ws0, t, ws1, c) { return {cases: [[c.conditions, c.block]], raw: ws0 + t + ws1 + c.raw}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2], result0[3]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }

    ...
    parse: function(input, startRule) {
      ...
      function parse_expressionworthy() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, ws, fn) { return new Nodes.PrefixIncrementOp(e).r('++' + ws + fn.raw).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, line, column, ws, fn) { return new Nodes.PrefixDecrementOp(e).r('--' + ws + fn.raw).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
            }
            if (result0 === null) {
              pos = clone(pos0);
            }
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column, ws, fn) { return new Nodes.UnaryPlusOp(e).r('+' + ws + fn.raw).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
              if (result0 === null) {
                ...
                if (result0 !== null) {
                  result0 = (function(offset, line, column, ws, fn) { return new Nodes.UnaryNegateOp(e).r('-' + ws + fn.raw).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
                }
                if (result0 === null) {
                  pos = clone(pos0);
                }
                if (result0 === null) {
                  ...
                  if (result0 !== null) {
                    result0 = (function(offset, line, column, o, ws, fn) { return new Nodes.LogicalNotOp(e).r(o + ws + fn.raw).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1], result0[2]);
                  }
                  if (result0 === null) {
                    pos = clone(pos0);
                  }
                  if (result0 === null) {
                    ...
                    if (result0 !== null) {
                      result0 = (function(offset, line, column, ws, fn) { return new Nodes.BitNotOp(e).r('~' + ws + fn.raw).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
                    }
                    if (result0 === null) {
                      pos = clone(pos0);
                    }
                    if (result0 === null) {
                      ...
                      if (result0 !== null) {
                        result0 = (function(offset, line, column, ws, fn) { return new Nodes.DoOp(e).r('do' + ws + fn.raw).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
                      }
                      if (result0 === null) {
                        pos = clone(pos0);
                      }
                      if (result0 === null) {
                        ...
                        if (result0 !== null) {
                          result0 = (function(offset, line, column, ws, fn) { return new Nodes.TypeofOp(e).r('typeof' + ws + fn.raw).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
                        }
                        if (result0 === null) {
                          pos = clone(pos0);
                        }
                        if (result0 === null) {
                          ...
                          if (result0 !== null) {
                            result0 = (function(offset, line, column, ws, fn) { return new Nodes.DeleteOp(e).r('delete' + ws + fn.raw).p(line, column); })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2]);
                          }
                          if (result0 === null) {
                            pos = clone(pos0);
                          }

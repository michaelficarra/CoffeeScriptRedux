...
this.Preprocessor = Preprocessor = function (super$) {
  ...
  function Preprocessor() {
    ...
    this.context = [];
    this.context.peek = function peek$() {
      if (this.length) {
    ...
    this.context.err = function err$(c) {
      throw new Error('Unexpected ' + inspect(c));
    };
    this.context.observe = function observe$(c) {
      var top;
      top = this.peek();
      switch (c) {
      case '"""':
  ...
  Preprocessor.prototype.p = function p$(s) {
    if (null != s)
      this.emit('data', s);
    return s;
  };
  Preprocessor.prototype.scan = function scan$(r) {
    return this.p(this.ss.scan(r));
  };
  processInput = function processInput$(isEnd) {
  ...
  Preprocessor.processSync = function processSync$(input) {
    var output, pre;
    pre = new Preprocessor;
    output = '';
    pre.emit = function emit$(type, data) {
      if (type === 'data')
        return output += data;
    };

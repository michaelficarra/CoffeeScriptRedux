...
patched = false;
patchStackTrace = function patchStackTrace$() {
  if (patched)
    return;
  patched = true;
  Module._sourceMaps = {};
  return Error.prepareStackTrace = function prepareStackTrace$(err, stack) {
...
exports.runMain = function runMain$(csSource, jsSource, jsAst, filename) {
  var mainModule;
...
runModule = function runModule$(module, jsSource, jsAst, filename) {
  patchStackTrace();

...
es6AssignmentPattern = function (assignee) {
  if (assignee['instanceof'](JS.ArrayExpression) && all(assignee.elements, function (elt) {
      return elt instanceof JS.Identifier;
    })) {
    return new JS.ArrayPattern(assignee.elements);
  }
};

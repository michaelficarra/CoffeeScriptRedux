...
exports.Compiler = function () {
  ...
  defaultRules = [
    ...
    [
      CS.Class,
      function (param$) {
        var _, ancestry, args, block, body, c, cache$2, cache$3, classAssignment, classExpression, classIdentifier, compile, ctorBody, ctorIndex, ctorRef, i, iife, instance, member, memberName, methods, nameAssignee, options, params, parent, parentIdentifier, parentRef, properties, protoAssignOp, protoMember, ps, rewriteThis, unmatched;
        var ctor, name;
        {
          cache$2 = param$;

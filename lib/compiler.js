...
findES6Methods = function (classIdentifier, body) {
  var expression, inner, methods, properties, rest;
  methods = [];
  properties = [];
  rest = [];
  for (var i$ = 0, length$ = body.expressions.length; i$ < length$; ++i$) {
    expression = body.expressions[i$];
  ...
  defaultRules = [
    ...
    [
      ...
      function () {
        ...
        return function (param$) {
          var alternate, ancestry, block, cache$2, consequent, i, index, inScope, last, newThis, numArgs, numParams, options, p, parameters_, paramName, performedRewrite, pIndex, reassignments, rest, rewriteThis, test;
          var body, parameters;
          {
            cache$2 = param$;
    ...
    [
      ...
      function (param$) {
        ...
        if (options.targetES6) {
          ...
          cache$3 = findES6Methods(classIdentifier, body);

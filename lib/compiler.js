    ...
    for (var i$ = 0, length$ = node.childNodes.length; i$ < length$; ++i$) {
      ...
      node[childName] = in$(childName, node.listMembers) ? function (accum$) {
        for (var i$1 = 0, length$1 = node[childName].length; i$1 < length$1; ++i$1) {
          ...
          accum$.push('undefined' !== typeof n && null != n ? fn.apply(n, args) : void 0);
        }
        return accum$;
...
declarationsNeededRecursive = function (node) {
  ...
  if (node['instanceof'](JS.FunctionExpression, JS.FunctionDeclaration, JS.ArrowFunctionExpression) && !node.generated) {
    return [];
  } else {
  ...
  Compiler.prototype.compile = function () {
    ...
    generateSymbols = function () {
      ...
      return generateMutatingWalker(function (state) {
        ...
        usedSymbols = cache$2.usedSymbols;
        nsCounters = cache$2.nsCounters;
        newNode = this['instanceof'](JS.GenSym) ? (newNode = new JS.Identifier(generateName(this, state)), usedSymbols.push(newNode.name), newNode) : this['instanceof'](JS.FunctionExpression, JS.FunctionDeclaration, JS.ArrowFunctionExpression) && !this.generated ? (params = concatMap(this.params, collectIdentifiers), nsCounters_ = {}, function (accum$) {
          for (k in nsCounters) {

...
exports.Compiler = function () {
  ...
  defaultRules = [
    ...
    [
      CS.Class,
      function (param$) {
        var _, args, block, body, c, cache$2, cache$3, classIdentifier, compile, ctorBody, ctorIndex, ctorRef, i, iife, instance, member, memberName, methods, nameAssignee, options, params, parent, parentIdentifier, parentRef, properties, protoAssignOp, protoMember, ps, rewriteThis, unmatched;
        var ctor, name;
        {
          cache$2 = param$;
        ...
        if (options.targetES6) {
          ...
          if (unmatched.length === 0 && (!this.ctor || this.ctor.expression['instanceof'](CS.Functions)) && (!nameAssignee || nameAssignee['instanceof'](JS.Identifier))) {

...
exports.Compiler = function () {
  ...
  defaultRules = [
    ...
    [
      CS.ForIn,
      function (param$) {
        var block, body, cache$2, compile, e, es6Target, filter, i, increment, k, keyAssignee, length, op, options, rangeArgs, step, target, update, valAssignee, varDeclaration;
        {
          cache$2 = param$;

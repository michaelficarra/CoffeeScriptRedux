...
findES6Methods = function (classIdentifier, body) {
  var expression, m, methodIdentifier, methods, object, properties, property, propertyName, rewriteThis, statement, unmatched;
  methods = [];
  properties = [];
  unmatched = [];
...
exports.Compiler = function () {
  ...
  defaultRules = [
    ...
    [
      CS.Class,
      function (param$) {
        var _, ancestry, args, block, body, c, cache$2, cache$3, classAssignment, classExpression, classIdentifier, compile, ctorBody, ctorIndex, ctorRef, i, iife, instance, member, memberName, methods, nameAssignee, options, params, parent, parentIdentifier, parentRef, properties, protoAssignOp, protoMember, ps, rewriteThis, safeCtor, unmatched;
        var ctor, name;
        {
          cache$2 = param$;
        ...
        if (options.targetES6) {
          ...
          if (ctor && (safeCtor = es6SafeConstructor(null != parent, ctor.body))) {
            for (var i$ = 0, length$ = unmatched.length; i$ < length$; ++i$) {
              c = unmatched[i$];
              i = i$;

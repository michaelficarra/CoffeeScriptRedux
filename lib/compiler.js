...
exports.Compiler = function () {
  ...
  defaultRules = [
    ...
    [
      CS.Class,
      function (param$) {
        var _, args, block, body, c, cache$2, compile, ctor, ctorBody, ctorIndex, ctorRef, i, iife, instance, member, memberName, name, nameAssignee, params, parent, parentRef, protoAssignOp, protoMember, ps, rewriteThis;
        {
          cache$2 = param$;

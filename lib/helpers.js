...
exports.numberLines = numberLines = function (input, startLine) {
...
exports.humanReadable = humanReadable = function (str) {
  return str.replace(/\uEFEF/g, '(INDENT)').replace(/\uEFFE/g, '(DEDENT)').replace(/\uEFFF/g, '(TERM)');
};
exports.formatParserError = function (input, e) {
...
exports.pointToErrorLocation = pointToErrorLocation = function (source, line, column, numLinesOfContext) {
...
exports.beingDeclared = beingDeclared = function (assignment) {
  switch (false) {
...
exports.declarationsFor = function (node, inScope) {
  var vars;
...
exports.usedAsExpression = usedAsExpression = function (node, ancestors) {
...
exports.envEnrichments = envEnrichments = function (node) {
  var args;

...
var ArrayExpression, ArrayPattern, ArrowFunctionExpression, AssignmentExpression, BinaryExpression, BlockStatement, cache$, cache$1, CallExpression, ClassBody, createNode, ctor, difference, exports, FunctionDeclaration, FunctionExpression, GenSym, handleLists, handlePrimitives, Identifier, isStatement, Literal, LogicalExpression, MemberExpression, NewExpression, node, nodeData, Nodes, ObjectExpression, ObjectPattern, params, Program, SequenceExpression, SwitchCase, SwitchStatement, TryStatement, UnaryExpression, UpdateExpression, VariableDeclaration;
...
exports.Nodes = Nodes = function () {
  ...
  Nodes.prototype.shallowCopy = function () {
    var c, k, v;
    c = new this.constructor;
    for (k in this) {
      v = this[k];
      if (k && in$(k, this.listMembers)) {
        k = k.slice();
      }
      c[k] = v;
    }
...
ObjectPattern = cache$1.ObjectPattern;

module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c0 = peg$FAILED,
        peg$c1 = null,
        peg$c2 = function(leader, b) {return (function() {
          return this.rp(new this.CS.Program(b));
        }).apply(__initializer);
        },
        peg$c3 = [],
        peg$c4 = function(s) {return (function() {
          return s;
        }).apply(__initializer);
        },
        peg$c5 = function(s, ss) {var __slice = [].slice;

        return (function() {
          return this.rp(new this.CS.Block([s].concat(__slice.call(ss))));
        }).apply(__initializer);
        },
        peg$c6 = void 0,
        peg$c7 = ";",
        peg$c8 = { type: "literal", value: ";", description: "\";\"" },
        peg$c9 = function(e) {return (function() {
          return e;
        }).apply(__initializer);
        },
        peg$c10 = function(left, right) {return (function() {
          if (!right) {
            return left;
          }
          return this.rp(new this.CS.SeqOp(left, right));
        }).apply(__initializer);
        },
        peg$c11 = function(expr, postfixes) {return (function() {
          var _this = this;
          return this.foldl(function(expr, postfixContainer) {
            var indicator, postfix;
            postfix = postfixContainer[1];
            indicator = postfix.type;
            switch (indicator) {
              case 'if':
                return _this.rp(new _this.CS.Conditional(postfix.cond, expr, null));
              case 'unless':
                return _this.rp(new _this.CS.NegatedConditional(new _this.CS.LogicalNotOp(postfix.cond).g(), expr, null));
              case 'while':
                return _this.rp(new _this.CS.While(postfix.cond, expr));
              case 'until':
                return _this.rp(new _this.CS.NegatedWhile(new _this.CS.LogicalNotOp(postfix.cond).g(), expr));
              case 'for-in':
                return _this.rp(new _this.CS.ForIn(postfix.val, postfix.key, postfix.list, postfix.step, postfix.filter, expr));
              case 'for-of':
                return _this.rp(new _this.CS.ForOf(postfix.own, postfix.key, postfix.val, postfix.obj, postfix.filter, expr));
            }
          }, expr, postfixes);
        }).apply(__initializer);
        },
        peg$c12 = function(kw, e) {return (function() {
          return {
            type: kw,
            cond: e
          };
        ...
        peg$c15 = function(a) {return (function() {
          return a;
        }).apply(__initializer);
        },
        peg$c16 = function(val, key) {return (function() {
          return [val, key];
        }).apply(__initializer);
        },
        peg$c17 = function(valKey, list, step, filter) {return (function() {
          var key, val, _ref;
          _ref = typeof valKey !== "undefined" && valKey !== null ? valKey : [null, null], val = _ref[0], key = _ref[1];
          return {
            type: 'for-in',
            val: val,
            key: key,
            list: list,
            step: typeof step !== "undefined" && step !== null ? step : new this.CS.Int(1).r('1').g(),
            filter: filter
          };
        }).apply(__initializer);
        },
        peg$c18 = function(own, key, val, obj, filter) {return (function() {
          return {
            type: 'for-of',
            own: Boolean(own),
            key: key,
        ...
        peg$c21 = function(left, right) {return (function() {
          return this.rp(new this.CS.AssignOp(left, right));
        }).apply(__initializer);
        },
        peg$c22 = "?",
        peg$c23 = { type: "literal", value: "?", description: "\"?\"" },
        peg$c24 = function(left, op, right) {return (function() {
          return this.rp(new this.CS.CompoundAssignOp(this.constructorLookup[op].prototype.className, left, right));
        }).apply(__initializer);
        },
        peg$c25 = "&&",
        ...
        peg$c45 = function(left, right) {return (function() {
          return this.rp(new this.CS.CompoundAssignOp(this.constructorLookup['?'].prototype.className, left, right));
        }).apply(__initializer);
        },
        peg$c46 = function(o, e) {return (function() {
          return [o, e];
        }).apply(__initializer);
        },
        peg$c47 = function(left, rights) {return (function() {
          var expr, op, _ref, _ref1;
          switch (rights.length) {
            case 0:
              return left;
            case 1:
              _ref = rights[0], op = _ref[0], expr = _ref[1];
              return this.rp(new this.constructorLookup[op](left, expr));
            default:
              return this.rp(this.foldBinaryExpr((_ref1 = [left]).concat.apply(_ref1, rights)));
          }
        }).apply(__initializer);
        },
        peg$c48 = "<=",
        ...
        peg$c60 = function(op) {return (function() {
          return "not " + op;
        }).apply(__initializer);
        },
        peg$c61 = function(e) {return (function() {
          return this.rp(new this.CS.DoOp(e));
        }).apply(__initializer);
        },
        peg$c62 = function(o) {return (function() {
          return o;
        }).apply(__initializer);
        },
        peg$c63 = function(ops, e) {return (function() {
          var _this = this;
          return this.rp(this.foldr(function(e, op) {
            return new _this.prefixConstructorLookup[op](e);
          }, e, ops));
        }).apply(__initializer);
        },
        peg$c64 = "++",
        ...
        peg$c72 = function(a, f) {return (function() {
          return this.rp(new this.CS.AssignOp(a, f));
        }).apply(__initializer);
        },
        peg$c73 = function(e, ops) {return (function() {
          var _this = this;
          return this.rp(this.foldl(function(e, op) {
            return new _this.postfixConstructorLookup[op](e);
          }, e, ops));
        }).apply(__initializer);
        },
        peg$c74 = "[..]",
        ...
        peg$c80 = function(soaked, a) {return (function() {
          return this.rp({
            op: soaked ? this.CS.SoakedFunctionApplication : this.CS.FunctionApplication,
            operands: [typeof a !== "undefined" && a !== null ? a : []]
          });
        }).apply(__initializer);
        },
        peg$c81 = function(e, es) {var __slice = [].slice;

        return (function() {
          return [e].concat(__slice.call(es));
        }).apply(__initializer);
        },
        peg$c82 = /^[+-\/]/,
        peg$c83 = { type: "class", value: "[+-\\/]", description: "[+-\\/]" },
        peg$c84 = function(e, es, obj) {return (function() {
          es.unshift(e);
        ...
        peg$c85 = function(o) {return (function() {
          return [o];
        }).apply(__initializer);
        },
        peg$c86 = function(e, accesses, secondaryArgs) {return (function() {
          var fn, list, secondaryCtor, soaked;
          fn = typeof accesses !== "undefined" && accesses !== null ? this.createMemberExpression(e, accesses) : e;
          if (typeof secondaryArgs !== "undefined" && secondaryArgs !== null) {
            soaked = secondaryArgs[0], list = secondaryArgs[1];
            secondaryCtor = soaked ? this.CS.SoakedFunctionApplication : this.CS.FunctionApplication;
            fn = this.rp(new secondaryCtor(fn, list));
          }
          return fn;
        }).apply(__initializer);
        },
        peg$c87 = function(as) {return (function() {
          return as;
        }).apply(__initializer);
        },
        peg$c88 = function(as, bs) {var __slice = [].slice;

        return (function() {
          return __slice.call(as).concat(__slice.call(typeof bs !== "undefined" && bs !== null ? bs : []));
        }).apply(__initializer);
        },
        peg$c89 = function(e) {return (function() {
          return this.rp(new this.CS.NewOp(e, []));
        }).apply(__initializer);
        },
        peg$c90 = function(e, args) {return (function() {
          return this.rp(new this.CS.NewOp(e, args.operands[0]));
        }).apply(__initializer);
        },
        peg$c91 = function(e, accesses) {return (function() {
          return this.createMemberExpression(e, accesses);
        }).apply(__initializer);
        },
        peg$c92 = function(e, args) {return (function() {
          return this.rp(new this.CS.NewOp(e, args));
        }).apply(__initializer);
        },
        peg$c93 = function(e, accesses) {return (function() {
          var acc;
          acc = this.foldl((function(memo, a) {
            return memo.concat(a);
          }), [], accesses);
          return this.createMemberExpression(e, acc);
        }).apply(__initializer);
        },
        peg$c94 = ".",
        peg$c95 = { type: "literal", value: ".", description: "\".\"" },
        peg$c96 = function(e) {return (function() {
          return this.rp({
            op: this.CS.MemberAccessOp,
            operands: [e]
          });
        }).apply(__initializer);
        },
        ...
        peg$c99 = function(e) {return (function() {
          return this.rp({
            op: this.CS.SoakedMemberAccessOp,
            operands: [e]
          });
        }).apply(__initializer);
        },
        ...
        peg$c104 = function(e) {return (function() {
          return this.rp({
            op: this.CS.DynamicMemberAccessOp,
            operands: [e]
          });
        }).apply(__initializer);
        },
        ...
        peg$c107 = function(e) {return (function() {
          return this.rp({
            op: this.CS.SoakedDynamicMemberAccessOp,
            operands: [e]
          });
        }).apply(__initializer);
        },
        ...
        peg$c110 = function(e) {return (function() {
          return this.rp({
            op: this.CS.ProtoMemberAccessOp,
            operands: [e]
          });
        }).apply(__initializer);
        },
        ...
        peg$c113 = function(e) {return (function() {
          return this.rp({
            op: this.CS.DynamicProtoMemberAccessOp,
            operands: [e]
          });
        }).apply(__initializer);
        },
        ...
        peg$c116 = function(e) {return (function() {
          return this.rp({
            op: this.CS.SoakedProtoMemberAccessOp,
            operands: [e]
          });
        }).apply(__initializer);
        },
        ...
        peg$c119 = function(e) {return (function() {
          return this.rp({
            op: this.CS.SoakedDynamicProtoMemberAccessOp,
            operands: [e]
          });
        }).apply(__initializer);
        },
        ...
        peg$c122 = function(left, exclusive, right) {return (function() {
          return this.rp({
            op: this.CS.Slice,
            operands: [!exclusive, left, right]
          });
        }).apply(__initializer);
        },
        peg$c123 = "@",
        peg$c124 = { type: "literal", value: "@", description: "\"@\"" },
        peg$c125 = function() {return (function() {
          return this.rp(new this.CS.This);
        }).apply(__initializer);
        },
        peg$c126 = function(e) {return (function() {
          return this.r(e.clone());
        }).apply(__initializer);
        },
        peg$c127 = function(a, m) {return (function() {
          return this.rp(new this.CS.MemberAccessOp(a, m));
        }).apply(__initializer);
        },
        peg$c128 = "`",
        ...
        peg$c132 = function(d) {return (function() {
          return this.rp(new this.CS.JavaScript(d));
        }).apply(__initializer);
        },
        peg$c133 = "...",
        peg$c134 = { type: "literal", value: "...", description: "\"...\"" },
        peg$c135 = function(e) {return (function() {
          return this.rp(new this.CS.Spread(e));
        }).apply(__initializer);
        },
        peg$c136 = function(kw, cond, body, elseClause) {return (function() {
          switch (kw) {
            case 'if':
              return this.rp(new this.CS.Conditional(cond, body.block, elseClause));
            case 'unless':
              return this.rp(new this.CS.NegatedConditional((new this.CS.LogicalNotOp(cond)).g(), body.block, elseClause));
          }
        }).apply(__initializer);
        },
        peg$c137 = function(b) {return (function() {
          return {
            block: b
          };
        }).apply(__initializer);
        },
        peg$c138 = function(s) {return (function() {
          return {
            block: s
          };
        }).apply(__initializer);
        },
        peg$c139 = function() {return (function() {
          return {
            block: null
          };
        }).apply(__initializer);
        },
        peg$c140 = function(b) {return (function() {
          return b;
        }).apply(__initializer);
        },
        peg$c141 = function(kw, cond, body) {return (function() {
          switch (kw) {
            case 'while':
              return this.rp(new this.CS.While(cond, body.block));
            case 'until':
              return this.rp(new this.CS.NegatedWhile((new this.CS.LogicalNotOp(cond)).g(), body.block));
          }
        }).apply(__initializer);
        },
        peg$c142 = function(body) {return (function() {
          return this.rp(new this.CS.Loop(body.block));
        }).apply(__initializer);
        },
        peg$c143 = function(body, c, f) {return (function() {
          var _ref, _ref1, _ref2;
          return this.rp(new this.CS.Try(body.block, (_ref = typeof c !== "undefined" && c !== null ? c.assignee : void 0) != null ? _ref : null, (_ref1 = typeof c !== "undefined" && c !== null ? c.block : void 0) != null ? _ref1 : null, (_ref2 = typeof f !== "undefined" && f !== null ? f.block : void 0) != null ? _ref2 : null));
        }).apply(__initializer);
        },
        peg$c144 = function(e, body) {return (function() {
          return this.r({
            block: (typeof body !== "undefined" && body !== null ? body.block : new this.CS.Block([])),
            assignee: e
          });
        }).apply(__initializer);
        },
        peg$c145 = function(body) {return (function() {
          var _ref;
          return this.r({
            block: (_ref = typeof body !== "undefined" && body !== null ? body.block : void 0) != null ? _ref : null
          });
        }).apply(__initializer);
        },
        peg$c146 = function(name, parent, body) {return (function() {
          var boundMembers, ctor, m, stmts, _i, _len, _ref;
          ctor = null;
          boundMembers = [];
          stmts = typeof body !== "undefined" && body !== null ? (_ref = body.statements) != null ? _ref : [body] : [];
          for (_i = 0, _len = stmts.length; _i < _len; _i++) {
            m = stmts[_i];
            if (m["instanceof"](this.CS.Constructor)) {
              ctor = m;
            } else if ((m["instanceof"](this.CS.ClassProtoAssignOp)) && (m.expression["instanceof"](this.CS.BoundFunction))) {
              boundMembers.push(m);
            }
          }
          return this.rp(new this.CS.Class(name, parent, ctor, body, boundMembers));
        }).apply(__initializer);
        },
        peg$c147 = function(key) {return (function() {
          return (key["instanceof"](this.CS.String, this.CS.Identifier)) && key.data === 'constructor';
        }).apply(__initializer);
        },
        peg$c148 = ":",
        peg$c149 = { type: "literal", value: ":", description: "\":\"" },
        peg$c150 = function(key, e) {return (function() {
          var fn;
          fn = e["instanceof"](this.CS.BoundFunction) ? this.c(new this.CS.Function(e.parameters, e.body).r(e.raw), e) : e;
          return this.rp(new this.CS.Constructor(fn));
        }).apply(__initializer);
        },
        peg$c151 = function(e) {return (function() {
          return this.r({
            expr: e
          });
        }).apply(__initializer);
        },
        peg$c152 = function(key, e) {return (function() {
          return this.rp(new this.CS.AssignOp(key, e.expr));
        }).apply(__initializer);
        },
        peg$c153 = function(key, e) {return (function() {
          return this.rp(new this.CS.ClassProtoAssignOp(key, e.expr));
        }).apply(__initializer);
        },
        peg$c154 = function(own, key, val, obj, filter, body) {return (function() {
          return this.rp(new this.CS.ForOf(Boolean(own), key, val, obj, filter, body.block));
        }).apply(__initializer);
        },
        peg$c155 = function(valKey, list, step, filter, body) {return (function() {
          var key, val, _ref;
          _ref = typeof valKey !== "undefined" && valKey !== null ? valKey : [null, null], val = _ref[0], key = _ref[1];
          return this.rp(new this.CS.ForIn(val, key, list, typeof step !== "undefined" && step !== null ? step : new this.CS.Int(1).r('1').g(), filter, body.block));
        }).apply(__initializer);
        },
        peg$c156 = function(e, body) {return (function() {
          var _ref;
          return this.rp(new this.CS.Switch(e, body.cases, (_ref = body["else"]) != null ? _ref : null));
        }).apply(__initializer);
        },
        peg$c157 = function(b) {return (function() {
          return this.r({
            cases: b.cases,
            "else": b["else"]
          });
        ...
        peg$c158 = function(c) {return (function() {
          return this.r({
            cases: [c]
          });
        }).apply(__initializer);
        },
        peg$c159 = function() {return (function() {
          return this.r({
            cases: []
          });
        }).apply(__initializer);
        },
        peg$c160 = function(c) {return (function() {
          return c;
        }).apply(__initializer);
        },
        peg$c161 = function(c, cs, elseClause) {var __slice = [].slice;

        return (function() {
          return this.r({
            cases: [c].concat(__slice.call(cs)),
            "else": elseClause
          });
        }).apply(__initializer);
        },
        peg$c162 = function(conditions, body) {return (function() {
          return this.rp(new this.CS.SwitchCase(conditions, body.block));
        }).apply(__initializer);
        },
        peg$c163 = function(c, cs) {var __slice = [].slice;

        return (function() {
          return [c].concat(__slice.call(cs));
        }).apply(__initializer);
        },
        peg$c164 = function(p) {return (function() {
          return p;
        }).apply(__initializer);
        },
        peg$c165 = "->",
        ...
        peg$c169 = function(params, arrow, body) {return (function() {
          var constructor;
          constructor = (function() {
            switch (arrow) {
              case '->':
                return this.CS.Function;
              case '=>':
                return this.CS.BoundFunction;
            }
          }).call(this);
          return this.rp(new constructor(typeof params !== "undefined" && params !== null ? params : [], body));
        }).apply(__initializer);
        },
        peg$c170 = function(param, default_) {return (function() {
          return this.rp(new this.CS.DefaultParam(param, default_));
        }).apply(__initializer);
        },
        peg$c171 = function(a, rest) {return (function() {
          return this.rp(typeof rest !== "undefined" && rest !== null ? new this.CS.Rest(a) : a);
        }).apply(__initializer);
        },
        peg$c172 = function(left, exclusiveDot, right) {return (function() {
          var inclusive;
          inclusive = !exclusiveDot;
          return this.rp(new this.CS.Range(inclusive, left, right));
        }).apply(__initializer);
        },
        peg$c173 = function(members) {return (function() {
          return this.rp(new this.CS.ArrayInitialiser(members));
        }).apply(__initializer);
        },
        peg$c174 = function(members) {return (function() {
          return members;
        }).apply(__initializer);
        },
        peg$c175 = function(members) {return (function() {
          return typeof members !== "undefined" && members !== null ? members : [];
        }).apply(__initializer);
        },
        peg$c176 = "{",
        ...
        peg$c180 = function(members) {return (function() {
          return this.rp(new this.CS.ObjectInitialiser(members));
        }).apply(__initializer);
        },
        peg$c181 = function(v) {return (function() {
          var key;
          key = this.p(new this.CS.String(v.memberName).g());
          return this.rp(new this.CS.ObjectInitialiserMember(key, v));
        }).apply(__initializer);
        },
        peg$c182 = function(v) {return (function() {
          return this.rp(new this.CS.ObjectInitialiserMember(v, v));
        }).apply(__initializer);
        },
        peg$c183 = function(i) {return (function() {
          return this.rp(new this.CS.Identifier(i));
        }).apply(__initializer);
        },
        peg$c184 = function(key, val) {return (function() {
          return this.rp(new this.CS.ObjectInitialiserMember(key, val));
        }).apply(__initializer);
        },
        peg$c185 = "__LINE__",
        peg$c186 = { type: "literal", value: "__LINE__", description: "\"__LINE__\"" },
        peg$c187 = function() {return (function() {
          return this.rp(new this.CS.Int(line()));
        }).apply(__initializer);
        },
        peg$c188 = "__FILENAME__",
        peg$c189 = { type: "literal", value: "__FILENAME__", description: "\"__FILENAME__\"" },
        peg$c190 = function() {return (function() {
          var _ref;
          return this.rp(new this.CS.String((_ref = options.inputSource) != null ? _ref : ""));
        }).apply(__initializer);
        },
        peg$c191 = "__DATE__",
        peg$c192 = { type: "literal", value: "__DATE__", description: "\"__DATE__\"" },
        peg$c193 = function() {return (function() {
          return this.rp(new this.CS.String((new Date).toDateString().slice(4)));
        }).apply(__initializer);
        },
        peg$c194 = "__TIME__",
        peg$c195 = { type: "literal", value: "__TIME__", description: "\"__TIME__\"" },
        peg$c196 = function() {return (function() {
          return this.rp(new this.CS.String((new Date).toTimeString().slice(0, 8)));
        }).apply(__initializer);
        },
        peg$c197 = "__DATETIMEMS__",
        peg$c198 = { type: "literal", value: "__DATETIMEMS__", description: "\"__DATETIMEMS__\"" },
        peg$c199 = function() {return (function() {
          return this.rp(new this.CS.Int(+(new Date)));
        }).apply(__initializer);
        },
        peg$c200 = "__COFFEE_VERSION__",
        peg$c201 = { type: "literal", value: "__COFFEE_VERSION__", description: "\"__COFFEE_VERSION__\"" },
        peg$c202 = function() {return (function() {
          return this.rp(new this.CS.String((require('../package.json')).version));
        }).apply(__initializer);
        },
        peg$c203 = function() {return (function() {
          return this.rp(new this.CS.Bool(true));
        }).apply(__initializer);
        },
        peg$c204 = function() {return (function() {
          return this.rp(new this.CS.Bool(false));
        }).apply(__initializer);
        },
        peg$c205 = "0b",
        peg$c206 = { type: "literal", value: "0b", description: "\"0b\"" },
        peg$c207 = function(bs) {return (function() {
          return this.rp(new this.CS.Int(parseInt(bs, 2)));
        }).apply(__initializer);
        },
        peg$c208 = "0o",
        peg$c209 = { type: "literal", value: "0o", description: "\"0o\"" },
        peg$c210 = function(os) {return (function() {
          return this.rp(new this.CS.Int(parseInt(os, 8)));
        }).apply(__initializer);
        },
        peg$c211 = "0x",
        peg$c212 = { type: "literal", value: "0x", description: "\"0x\"" },
        peg$c213 = function(hs) {return (function() {
          return this.rp(new this.CS.Int(parseInt(hs, 16)));
        }).apply(__initializer);
        },
        peg$c214 = /^[eE]/,
        ...
        peg$c218 = function(base, e, sign, exponent) {return (function() {
          return this.rp(new this.CS.Float(parseFloat("" + base.data + e + (typeof sign !== "undefined" && sign !== null ? sign : '') + exponent.data)));
        }).apply(__initializer);
        },
        peg$c219 = function(integral, fractional) {return (function() {
          if (fractional) {
            return this.rp(new this.CS.Float(parseFloat(integral + fractional)));
          } else {
            return this.rp(new this.CS.Int(+integral));
          }
        }).apply(__initializer);
        },
        peg$c220 = "0",
        ...
        peg$c238 = function(d) {return (function() {
          return this.rp(new this.CS.String(this.stripLeadingWhitespace(d.join(''))));
        }).apply(__initializer);
        },
        peg$c239 = "'''",
        ...
        peg$c243 = function(d) {return (function() {
          return this.rp(new this.CS.String(d.join('')));
        }).apply(__initializer);
        },
        peg$c244 = /^[^"'\\#]/,
        ...
        peg$c276 = function(es) {return (function() {
          return this.rp(this.createInterpolation(this.stripLeadingWhitespaceInterpolation(es)));
        }).apply(__initializer);
        },
        peg$c277 = function(es) {return (function() {
          return this.rp(this.createInterpolation(es));
        }).apply(__initializer);
        },
        peg$c278 = "///",
        ...
        peg$c282 = function() {return (function() {
          return [this.rp(new this.CS.String('').g())];
        }).apply(__initializer);
        },
        peg$c283 = /^[^\\\/#[ \r\n]/,
        peg$c284 = { type: "class", value: "[^\\\\\\/#[ \\r\\n]", description: "[^\\\\\\/#[ \\r\\n]" },
        peg$c285 = function(s) {return (function() {
          return [this.rp((new this.CS.String(s)).g())];
        }).apply(__initializer);
        },
        peg$c286 = /^[gimy]/,
        peg$c287 = { type: "class", value: "[gimy]", description: "[gimy]" },
        peg$c288 = function(es, flags) {return (function() {
          var interp;
          if (!this.isValidRegExpFlags(flags)) {
            throw new SyntaxError(['regular expression flags'], 'regular expression flags', offset(), line(), column());
          }
          interp = this.createInterpolation(this.foldl((function(memo, e) {
            return memo.concat(e);
          }), [], es));
          if (interp instanceof this.CS.String) {
            return this.p(new this.CS.RegExp(interp.data, flags));
          }
          return this.rp(new this.CS.HeregExp(interp, flags));
        }).apply(__initializer);
        },
        peg$c289 = "/",
        ...
        peg$c293 = function(d, flags) {return (function() {
          if (!this.isValidRegExpFlags(flags)) {
            throw new SyntaxError(['regular expression flags'], 'regular expression flags', offset(), line(), column());
          }
          return this.rp(new this.CS.RegExp(d, flags));
        }).apply(__initializer);
        },
        peg$c294 = /^[^\\\]\n]/,
        peg$c295 = { type: "class", value: "[^\\\\\\]\\n]", description: "[^\\\\\\]\\n]" },
        peg$c296 = function(h) {return (function() {
          return h[0];
        }).apply(__initializer);
        },
        peg$c297 = /^[^\\\/\]]/,
        peg$c298 = { type: "class", value: "[^\\\\\\/\\]]", description: "[^\\\\\\/\\]]" },
        peg$c299 = function(s) {return (function() {
          return this.p(new this.CS.String(s));
        }).apply(__initializer);
        },
        peg$c300 = function(d) {var __slice = [].slice;

        return (function() {
          return [this.p(new this.CS.String("["))].concat(__slice.call(d), [this.p(new this.CS.String("]"))]);
        }).apply(__initializer);
        },
        peg$c301 = function(d) {return (function() {
          return [this.rp(new this.CS.String(d))];
        }).apply(__initializer);
        },
        peg$c302 = function(s) {return (function() {
          return [this.rp(new this.CS.String(s))];
        }).apply(__initializer);
        },
        peg$c303 = function(c) {return (function() {
          return [this.rp(new this.CS.String(c))];
        }).apply(__initializer);
        },
        peg$c304 = function(e) {return (function() {
          return [e];
        }).apply(__initializer);
        },
        peg$c305 = function(e) {return (function() {
          return this.rp(new this.CS.Throw(e));
        }).apply(__initializer);
        },
        peg$c306 = function(e) {return (function() {
          return this.rp(new this.CS.Return(e));
        }).apply(__initializer);
        },
        peg$c307 = function() {return (function() {
          return this.rp(new this.CS.Continue);
        }).apply(__initializer);
        },
        peg$c308 = function() {return (function() {
          return this.rp(new this.CS.Break);
        }).apply(__initializer);
        },
        peg$c309 = function() {return (function() {
          return this.rp(new this.CS.Debugger);
        }).apply(__initializer);
        },
        peg$c310 = function() {return (function() {
          return this.rp(new this.CS.Undefined);
        }).apply(__initializer);
        },
        peg$c311 = function() {return (function() {
          return this.rp(new this.CS.Null);
        }).apply(__initializer);
        },
        peg$c312 = "arguments",
        ...
        peg$c316 = function(i) {return (function() {
          return i;
        }).apply(__initializer);
        },
        peg$c317 = function(v) {return (function() {
          var key;
          key = this.rp(new this.CS.String(v.memberName));
          return this.rp(new this.CS.ObjectInitialiserMember(key, v));
        }).apply(__initializer);
        },
        peg$c318 = function(i) {return (function() {
          return this.rp(new this.CS.ObjectInitialiserMember(i, i));
        }).apply(__initializer);
        },
        peg$c319 = /^[$_]/,
        ...
        peg$c333 = function(ws) {return (function() {
          return ws;
        }).apply(__initializer);
        },
        peg$c334 = "\uEFFE",
        ...
        peg$c338 = function() {return (function() {
          return '';
        }).apply(__initializer);
        },
        peg$c339 = "and",
        ...
        peg$c469 = function(h0, h1, h2, h3) {return (function() {
    ...
    __initializer = (function() {
      var LEFT_ASSOCIATIVE, RIGHT_ASSOCIATIVE, associativities, chainableComparisonOps, id, negatableOps, op, precedenceHierarchy, precedenceTable, rightAssocOps, _fn, _i, _len,
        _this = this;
      this.CS = require('./nodes');
      this.constructorLookup = {
        '||': this.CS.LogicalOrOp,
        'or': this.CS.LogicalOrOp,
        '&&': this.CS.LogicalAndOp,
        'and': this.CS.LogicalAndOp,
        '|': this.CS.BitOrOp,
        '^': this.CS.BitXorOp,
        '&': this.CS.BitAndOp,
        '?': this.CS.ExistsOp,
        ...
        '<': this.CS.LTOp,
        '>': this.CS.GTOp,
        'extends': this.CS.ExtendsOp,
        'instanceof': this.CS.InstanceofOp,
        'in': this.CS.InOp,
        'of': this.CS.OfOp,
        '<<': this.CS.LeftShiftOp,
        '>>': this.CS.SignedRightShiftOp,
        '>>>': this.CS.UnsignedRightShiftOp,
        '+': this.CS.PlusOp,
        '-': this.CS.SubtractOp,
        '*': this.CS.MultiplyOp,
        '/': this.CS.DivideOp,
      ...
      rightAssocOps = [';', '=', '?', '**'];
      precedenceHierarchy = [['or', '||'], ['and', '&&'], ['|'], ['^'], ['&'], ['?'], ['is', '==', 'isnt', '!='], ['instanceof', 'in', 'of', '<=', '>=', '<', '>'], ['<<', '>>', '>>>'], ['+', '-'], ['*', '/', '%'], ['**']];
      precedenceTable = (function() {
        var level, op, ops, table, _i, _j, _len, _len1;
        table = {};
        for (level = _i = 0, _len = precedenceHierarchy.length; _i < _len; level = ++_i) {
      ...
      associativities = (function() {
        var op, result, rightAssocOp, _i, _len;
        result = {};
        for (op in precedenceTable) {
          if (!__hasProp.call(precedenceTable, op)) continue;
          result[op] = LEFT_ASSOCIATIVE;
        }
        for (_i = 0, _len = rightAssocOps.length; _i < _len; _i++) {
          rightAssocOp = rightAssocOps[_i];
      ...
      _fn = function(op) {
        var fn, negatedOp;
        fn = function(a, b) {
          return new _this.CS.LogicalNotOp(new _this.constructorLookup[op](a, b));
        };
        fn.prototype = _this.constructorLookup[op].prototype;
        negatedOp = "not " + op;
        _this.constructorLookup[negatedOp] = fn;
        precedenceTable[negatedOp] = precedenceTable[op];
        return associativities[negatedOp] = associativities[op];
      };
      for (_i = 0, _len = negatableOps.length; _i < _len; _i++) {
        op = negatableOps[_i];
        _fn(op);
      }
      this.prefixConstructorLookup = {
        '++': this.CS.PreIncrementOp,
        '--': this.CS.PreDecrementOp,
        '+': this.CS.UnaryPlusOp,
        '-': this.CS.UnaryNegateOp,
        '!': this.CS.LogicalNotOp,
        'not': this.CS.LogicalNotOp,
        '~': this.CS.BitNotOp,
        'do': this.CS.DoOp,
        'typeof': this.CS.TypeofOp,
        'delete': this.CS.DeleteOp
      };
      this.postfixConstructorLookup = {
        '?': this.CS.UnaryExistsOp,
        '[..]': this.CS.ShallowCopyArray,
        '++': this.CS.PostIncrementOp,
        '--': this.CS.PostDecrementOp
      };
      this.foldl = function(fn, memo, list) {
        var item, _j, _len1;
      ...
      this.foldr = function(fn, memo, list) {
        var item, _j;
      ...
      this.foldBinaryExpr = function(parts, ignoreChains) {
        ...
        while (parts.length > 0) {
          ...
          if (!ignoreChains && stack.length > 2) {
            ...
            if (__indexOf.call(chainableComparisonOps, operator) >= 0 && __indexOf.call(chainableComparisonOps, nextOp) >= 0) {
              ...
              while (true) {
                ...
                if (!((nextOp != null) && (nextPrec > prec || __indexOf.call(chainableComparisonOps, nextOp) >= 0))) {
                  break;
                }
              }
              stack.push(new _this.CS.ChainedComparisonOp(_this.foldBinaryExpr(chainStack, true)));
              continue;
            }
          }
          while (stack.length > 2 && (operator = stack[stack.length - 2], prec = precedenceTable[operator], nextPrec = precedenceTable[nextOp], nextPrec < prec || __indexOf.call(chainableComparisonOps, operator) >= 0 && __indexOf.call(chainableComparisonOps, nextOp) >= 0 || nextPrec === prec && associativities[operator] === LEFT_ASSOCIATIVE)) {
            rightOperand = stack.pop();
            stack.pop();
            leftOperand = stack.pop();
            stack.push(new _this.constructorLookup[operator](leftOperand, rightOperand));
          }
        ...
        while (stack.length > 0) {
          expr = new _this.constructorLookup[stack.pop()](stack.pop(), expr);
        }
        return expr;
      };
      this.createInterpolation = function(es) {
        var init;
        init = new _this.CS.String('').g();
        return _this.foldl(function(memo, s) {
          var left;
          if (s instanceof _this.CS.String) {
            left = memo;
            while (left) {
              if (left instanceof _this.CS.String) {
                if (left === init) {
                  _this.c(left, s);
                ...
                return memo;
              } else if (left instanceof _this.CS.ConcatOp) {
                left = left.right;
              } else {
                break;
              }
          ...
          return new _this.CS.ConcatOp(memo, s);
        }, init, es);
      };
      this.createMemberExpression = function(e, accesses) {
        return _this.foldl(function(left, access) {
          var F, o, _ref;
          F = function() {};
          F.prototype = access.op.prototype;
          o = new F;
          (_ref = access.op).call.apply(_ref, [o, left].concat(__slice.call(access.operands)));
          return _this.c(o.r(left.raw + access.raw), e);
        }, e, accesses);
      };
      this.isValidRegExpFlags = function(flags) {
        var f, flag, _j, _len1;
        if (!flags) {
          return true;
        }
        ...
        flags.sort();
        flag = null;
        for (_j = 0, _len1 = flags.length; _j < _len1; _j++) {
          f = flags[_j];
          if (flag === f) {
            return false;
          }
      ...
      this.stripLeadingWhitespace = function(str) {
        var attempt, indent, match, matchStr, wholeMatch, _ref;
        str = str.trimRight();
        matchStr = str;
        indent = null;
        while (match = /\n+([^\n\S]*)/.exec(matchStr)) {
          wholeMatch = match[0], attempt = match[1];
      ...
      this.stripLeadingWhitespaceInterpolation = function(pieces) {
        var attempt, indent, index, match, matchStr, piece, wholeMatch, _j, _k, _len1, _len2, _ref;
        indent = null;
        for (index = _j = 0, _len1 = pieces.length; _j < _len1; index = ++_j) {
          piece = pieces[index];
          if (piece instanceof _this.CS.String) {
        ...
        if (indent) {
          for (index = _k = 0, _len2 = pieces.length; _k < _len2; index = ++_k) {
            piece = pieces[index];
            if (piece instanceof _this.CS.String) {
              piece.data = piece.data.replace(RegExp("\\n" + indent, "g"), '\n');
              if (index === pieces.length - 1) {
      ...
      this.rp = function(node) {
        return _this.r(_this.p(node));
      };
      this.c = function(to, from) {
        to.line = from.line;

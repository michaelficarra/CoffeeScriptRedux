...
class
  ...
  classStatement
    ...
    / expression
  constructor
    = (key:ObjectInitialiserKeys &{ return key.instanceof(CS.String, CS.Identifier) && 'constructor' === key.data; }) _ ":" _ e:
...
Numbers
  ...
  / base:decimal e:[eE] sign:[+-]? exponent:decimal {
      return rp(new CS.Float(parseFloat('' + base.data + e + (sign ? sign : '') + exponent.data, 10)));
    }
  / decimal
